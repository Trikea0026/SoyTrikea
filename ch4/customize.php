<?php 
	...
	if (isset($_POST['font_size'], $_POST['font_color'])) {
		// Send the cookies:
		setcookie('font_size', $_POST['font_size'], time()+3600, '/', '', 0);
		setcookie('font_color',$_POST['font_color'],time()+3600, '/', '', 0);
		$msg = '<p>Click here to see settings<a href="view_settings.php">
		settings</a>.</p>';	// Message to be printed later:
	}  
?>
<!doctype html>
<html lang="en">
